...
\cvevent{Graduate Software Engineer}{Leonardo MW LTD}{July 2019 -- Current}{Edinburgh, UK}
\begin{itemize}
\item Leonardo S.p.A., formerly Leonardo-Finmeccanica and Finmeccanica, is an Italian multinational company specialising in aerospace, defence and security. Headquartered in Rome, the company has 180 sites worldwide. 
\divider
\end{itemize}

\cvevent{Supervisor}{Shimla LTD (Shamoli Restaurant)}{August 2017 -- August 2019}{Edinburgh, UK}
\begin{itemize}
